...
@AllArgsConstructor
@Builder
public class MatchScheduleDraftResponseDto {
    @Schema(description = "ID of the match schedule draft", example = "1")
    private Integer id;
    ...
    @Schema(description = "Status of the draft", example = "PENDING")
    private DraftStatusEnum status;

    @Schema(description = "Basic info of the tournament this match draft belongs to")
